...
fitsname1 = 'E:\\shunbianyuan\\ldf_download\\20190921\\'+'NGC%2022.fts'
fitsname2 = 'E:\\shunbianyuan\\ldf_download\\l20190920\\'+'NGC%2022.fts'
...
for i in range(jiezhi):
    for j in range(jiezhi):
        if (abs(listsanjiaoA1[i][6]-listsanjiaoA2[j][6]) < 0.02 and abs(listsanjiaoA1[i][7]-listsanjiaoA2[j][7]) < 8000):
...
'''
abs01 = abs(listtempA1[0][0]-listtempA2[0][0]) - abs(listtempA1[0][1]-listtempA2[0][1])
abs02 = abs(listtempA1[0][0]-listtempA2[0][0]) - abs(listtempA1[0][1]-listtempA2[0][2])
abs10 = abs(listtempA1[0][0]-listtempA2[0][1]) - abs(listtempA1[0][1]-listtempA2[0][0])
abs12 = abs(listtempA1[0][0]-listtempA2[0][1]) - abs(listtempA1[0][1]-listtempA2[0][2])
abs20 = abs(listtempA1[0][0]-listtempA2[0][2]) - abs(listtempA1[0][1]-listtempA2[0][0])
abs21 = abs(listtempA1[0][0]-listtempA2[0][2]) - abs(listtempA1[0][1]-listtempA2[0][1])
